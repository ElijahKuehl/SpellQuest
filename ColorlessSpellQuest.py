...
def get_guild():
    ...
    raw_input("\nYellow Guild, proficient in Yellow Magic. Unlocks the spell Lightning.\n")
...
def chapter_two():
    ...
    if not badPath:
        if Noah and Samantha:
            ...
            raw_input(
                "Samantha: The Elder Wizard is the most powerful Wizard alive. He is a master of all colored spells.")
            raw_input(
                "Samantha: The spells he has are crazy powerful, and I bet the books for them are still in his room!")
            ...
            raw_input("Samantha: You are terrible people! I'm going back to SparkHQ, I will make them Hate you!")
            raw_input(
            ...
            raw_input("Samantha: This twat right here just abandoned his friend to save a Sparks.")
            crew = ["Samantha"]
            raw_input("Ethan: Your not a Sparks anymore Samantha.")
            ...
            if not badPath:
                ...
                library()
                raw_input(
                    "Samantha: Ha! It worked! The elder wizard used to be a Sparks, so he kinda has a soft spot for them. Thats why we get away with so much. It's a shame we got kicked out though...")
                raw_input(
                    "Samantha: Anyways, learning new spells is a good way to get experience. So you probably can level up!")
                raw_input("Level up! Max Hp +1")
                level += 1
                maxHp += 1
        ...
        if not badPath:
            ...
            while True:
                ...
                if lonely == "1":
                    ...
                    raw_input("Noah: Ugh.. What happened?")
                    raw_input("???: Someone defeated you in battle. I'm Thomson and Ill be your healer today.")
                    raw_input("Noah notices you.")
                    raw_input("Noah: Wait a minute, you did this to me " + name + "!")
                    raw_input("Thomson: You stay lying down, I'll deal with him.")
                    Enemy("Thomson:", 17, "None", "Green", ["Magic Beam", "Heal"])
                    raw_input("Thomson used Revive!")
                    raw_input("Thomson: You shouldn't be attacking people you stupid Spark! Everyone is valid!")
                    print "Thomson: Why would you do something like that? "
                    why = raw_input("1)I stood no chance against a spark, but I did against Noah. 2)I wanted to be a Spark. 3)He was dumb")
                    if why == "1":
                        raw_input("Thomson: Oh baloney! I saw you had Lightning!")
                        raw_input("Thomson: Get outta here kid!")
                    elif why == "2":
                        raw_input("Thomson: And how'd that work out for you? I saw that you didn't have the spell Sparks!")
                        raw_input("Thomson: Get outta here kid!")
                    elif why == "3":
                        raw_input("Thomson: Well it's not very smart for you to push away other people! Look at you! Now you don't have any friends!")
                        raw_input("Thomson: Get outta here kid!")
                    else:
                        raw_input("Thomson: Oh, your ashamed of it. As you should be.")
                        raw_input("Thomson: Why don't you make it up to him?")
                        raw_input("You go over to Noah")
                        apology = raw_input("1)I'm sorry. 2)Nerd.")
                        if apology == "1":
                            raw_input("Noah: I know you are. It was a smart move to get on The Sparks good side.")
                            raw_input("Noah: I think I've recovered now.")
                            raw_input("Thomson: That's great! So you two made up?")
                            raw_input("Noah: Yeah.")
                            crew = ["Noah", "Thomson"]
                        elif apology == "2":
                            raw_input("Noah: You deserve this.")
                            raw_input("Noah blasted a fireball into your face! It wasn't very effective, but it still hurt.")
                            raw_input("Thomson: Get outta here kid!")
                        else:
                            raw_input("Noah: You don't have anything to say?")
                            raw_input("Thomson: Get outta here kid!")
                    break
...
def elder_wizard():
    ...
    Enemy("Raged Elder Wizard", maxHp+1, "None", "Gold", ["Firewall", "Full Regenerate"])
...
def mountain():
    ...
    if path == "1":
        ...
        Enemy("The Snow Golem", randint(7, 12), "None", "Blue", ["Snowball"])
        raw_input("Level up! Max Hp +1")
        level += 1
        maxHp += 1
        ...
        if yorn.lower() in ["y", "yes"]:
            ...
            Enemy("???", 17, "Invisibile", "Gray", ["Bite", "Raged Claws"])
            raw_input("Level up! Max Hp +1")
            level += 1
            maxHp += 1
    ...
    raw_input("???: COOOOORRRAAAAAAAAAHHHHHHHH!")
    raw_input("What was that?")
    raw_input("A Snow Golem with a crown on it's head emerged from the snow! It's the Snow King!")
    raw_input("Snow King: Your color is Artificial! It must be eliminated!")
    Enemy("Snow King", 24, "None", "Gold", ["Frost Bite"])
    raw_input("Snow King: Artificial.. Yet good...")
    raw_input("Level up! Max Hp +1")
    level += 1
    maxHp += 1
...
def forest():
    ...
    raw_input("Noah:But we gotta learn that new Spell! I imagine it'll be useful when fighting the sparks!")
    raw_input("You cray a circle in the dirt with a stick around your " + object1)
    raw_input("Noah: Alright, to cast Raged Claws you must chant Le Grin Raginos Claus")
    while True:
        chant = raw_input("What do you chant?")
